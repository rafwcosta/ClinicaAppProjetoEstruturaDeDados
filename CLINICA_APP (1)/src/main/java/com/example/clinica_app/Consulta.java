 ...
 * horários de início e fim, e o status atual (DISPONIVEL, AGENDADA, CANCELADA).
 */
public class Consulta {
    ...
    /**
     * Construtor para uma consulta agendada, que inclui um paciente.
    ...
    /**
     * Construtor para um horário de disponibilidade, que não inclui um paciente.
    ...
    /** @return O status atual da consulta (ex: "AGENDADA", "DISPONIVEL"). */
    public String getStatus() { return status; }
    /** @return O motivo do cancelamento, ou null se não foi cancelada por um médico. */
     ...
     * @param status O novo status (ex: "AGENDADA", "CANCELADA").
     */
