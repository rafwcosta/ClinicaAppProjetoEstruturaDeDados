 ...
 * Esta classe armazena os dados cadastrais do paciente, como ID (CPF),
 * nome, idade, contato e o histórico de todas as suas consultas.
 */
public class Paciente {
     ...
     * @param contato    O número de contato (telefone/celular) do paciente.
     */
    ...
    /**
     * Retorna uma cópia da lista de todas as consultas no histórico do paciente.
