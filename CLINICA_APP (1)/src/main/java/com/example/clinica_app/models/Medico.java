...
/**
 * Representa um médico no sistema da clínica.
 * Esta classe armazena as informações básicas de um médico, como seu
 * identificador único (CRM), nome e especialidade.
 */
public class Medico {
     ...
     * @param especialidade A especialidade médica do profissional.
     */
